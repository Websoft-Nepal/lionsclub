...
class _ClubState extends State<Club> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: isLoading
          ? _buildSkeleton() // Show skeleton while data is being fetched
          : _buildClubList(), // Show actual data once data is fetched
    );
  }
                ...
                child: GestureDetector(
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              ClubDetAILS(clubId: clubs[index].id)));
                  },
                  child: Card(
                    elevation: 5,
                          ...
                          child: Column(
                            ...
                            children: [
                              Padding(
                                  ...
                                  child: Text(
                                    clubs[index].name != null &&
                                            clubs[index].name!.length > 20
